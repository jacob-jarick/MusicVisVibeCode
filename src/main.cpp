        ...
        if (arg == "--timeout" || arg == "-t") {
            ...
            if (i + 1 < argc) {
                ...
                if (visName == "spectrum" || visName == "0") {
                    ...
                    std::cout << "Available: spectrum (0), cybervalley2/cv2 (1), linefader/lf (2), spectrum2/s2 (3)" << std::endl;
                }
                i++; // Skip next arg
            }
            ...
            std::cout << "                        Options: spectrum (0), cybervalley2/cv2 (1), linefader/lf (2), spectrum2/s2 (3)" << std::endl;
